...
FeatureLabeler.prototype.getTextStyle = function(feature, resolution,fieldsInfo) {
 if(this.disabled){
   return null;
 }
 ...
 if(fieldsInfo && fieldsInfo[this.fieldName] ){
   codedValues =fieldsInfo[this.fieldName].codedValues;
 }
 ...
 var text= this.getText(feature, resolution,codedValues);
...
FeatureLabeler.prototype.getText = function(feature, resolution,codedValues) {
