...
ol.Overlay.Popup = function (options) {
	...
	if (options.stopEvent) {
	  ...
	  element.addEventListener("mousemove", function(e){ e.stopPropagation(); });
	  element.addEventListener("mouseup", function(e){ e.stopPropagation(); });
  ...
  */
  ol.Overlay.Popup.prototype.show = function (coordinate, html) {
	...
	if (!map) return;
	//iranshahi
	if(html && html.length && !(typeof html ==='string' || html instanceof String)){
		html=html[0];
	}
