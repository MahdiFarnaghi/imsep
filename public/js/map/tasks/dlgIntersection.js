...
function DlgIntersection(mapContainer,obj,options) {
  DlgTaskBase.call(this, 'DlgIntersection'
      ,(options.title || 'Intersection')
      ,  mapContainer,obj,options);   

}
DlgIntersection.prototype = Object.create(DlgTaskBase.prototype);


DlgIntersection.prototype.createUI=function(){
  var self=this;
  var layer= this.obj;
  ...
  htm+='  <p>';
  htm+='Generate Intersection of ('+ layer.get('title') +') and layer:';
  htm+='  </p>';
